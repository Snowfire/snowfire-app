...
class Service_Snowfire_Snowfire
{
	/**
	* @var Snowfire_Gui
	*/
	...
	*/
	...
	{		
		if (class_exists('Service_Snowfire_Storage', false)) {
			$this->storage = new Snowfire_Storage();
		}
		
		$this->gui = new Service_Snowfire_Gui();
...
*/
class Service_Snowfire_Component
{
	/**
	* @var Snowfire_Storage
	*/
...
class Service_Snowfire_Gui_View
{
	private $_data = array();
	private $_filename;
...
abstract class Service_Snowfire_StorageBase
{
	/**
